...
function rebuildUI()
    ...
    local arcsActive = config.MODULE_ARC
    ...
    local mainButtons = {}
    if (config.MODULE_ARC) then
        table.insert(mainButtons, {tag="button", attributes={id="btn_show_arc", active=(arcsActive and not arcsOn), height="30", width="30", rectAlignment="MiddleLeft", image="ui_arcs", offsetXY="20 0", colors="#ccccccff|#ffffffff|#404040ff|#808080ff", onClick="ui_showarc", visibility=config.PERMEDIT}})
        table.insert(mainButtons, {tag="button", attributes={id="btn_hide_arc", active=(arcsActive and arcsOn), height="30", width="30", rectAlignment="LowerLeft", image="ui_arcs", offsetXY="20 0", colors="#ccccccff|#ffffffff|#404040ff|#808080ff", onClick="ui_hidearc", visibility=config.PERMEDIT}})
